## 1. Techradar
![Techradar](./radar_1.png)
![Techradar](./radar_2.png)
## 2. Roadmap
...
| **2. Доменное разделение**                | Q2–Q3 2026 | Реализация Data Mesh, выделение доменов Clinic, Fintech, AI     | Независимое развитие направлений           | Архитектурная команда    | Kafka, DWH, DataOps    |
